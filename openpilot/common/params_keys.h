...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoVehicleHold", {PERSISTENT, BOOL, "0"}},
    {"BlinkerPauseDelay", {PERSISTENT, INT, "1"}},
    {"BlinkerPauseSpeed", {PERSISTENT, INT, "20"}},
    {"BootCount", {PERSISTENT, INT}},
    {"BrightnessLevel", {PERSISTENT, INT, "0"}},
    ...
    {"CurveAdvisory", {PERSISTENT, INT, "0"}},
    {"DisableLogging", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL}},
    {"DisablePowerDown", {PERSISTENT, BOOL}},
    {"DisableStopStart", {PERSISTENT, BOOL, "0"}},
    ...
    {"EngagementPathColor", {PERSISTENT, BOOL, "1"}},
    ...
    {"HideExperimentalButton", {PERSISTENT, BOOL, "1"}},
    ...
    {"MadsMainSwitch", {PERSISTENT, BOOL, "0"}},
    ...
    {"LeadDepartAlert", {PERSISTENT, BOOL, "1"}},
    {"OnroadDimLevel", {PERSISTENT, INT, "10"}},
    {"OnroadDimTimer", {PERSISTENT, INT, "0"}},
    ...
    {"RotateWheelIcon", {PERSISTENT, BOOL, "1"}},
    {"SecOCKey", {PERSISTENT | DONT_LOG, STRING}},
    {"ShowBlindSpot", {PERSISTENT, BOOL, "1"}},
    {"ShowConfidenceBall", {PERSISTENT, BOOL, "1"}},
    {"ShowDebugInfo", {PERSISTENT, BOOL}},
    {"ShowDebugPanel", {PERSISTENT, BOOL, "1"}},
    {"ShowHomeStatus", {PERSISTENT, BOOL, "1"}},
    {"ShowLeadIndicator", {PERSISTENT, BOOL, "1"}},
    {"ShowSteeringOnly", {PERSISTENT, BOOL, "1"}},
    {"ShowStockBrake", {PERSISTENT, BOOL, "1"}},
    ...
    {"WideCameraLowSpeed", {PERSISTENT, BOOL, "1"}},
};
